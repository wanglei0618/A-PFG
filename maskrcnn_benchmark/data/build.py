...
def make_batch_data_sampler(
    ...
    if not cfg.MODEL.feats_generation_mode and num_iters is not None:
...
def make_data_loader(cfg, mode='train', is_distributed=False, start_iter=0, dataset_to_test=None):
    ...
    if is_train:
        ...
        if cfg.MODEL.feats_generation_mode and cfg.MODEL.ROI_RELATION_HEAD.PREDICTOR == "MotifPredictor":
            images_per_gpu = 1
        shuffle = True if not cfg.MODEL.feats_generation_mode else False
