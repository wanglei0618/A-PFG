...
_C.MODEL.APFG_latent_size = 256
_C.MODEL.semantic_dim = 1024
_C.MODEL.APFG_Feats_generation = False
_C.MODEL.APFG_train = False
# ---------------------------------------------------------------------------- #
# Group Norm options
# ---------------------------------------------------------------------------- #
...
_C.SOLVER.APFG_batch = 64
_C.SOLVER.BASE_LR_APFG = 0.0002
_C.SOLVER.APFG_epoch = 200
_C.SOLVER.APFG_STEPS = (100,)
_C.SOLVER.weight_kl_delata = 0.0
_C.SOLVER.weight_da_delata = 0.0
_C.SOLVER.weight_cr_delata = 0.0
_C.SOLVER.weight_kl = 1.0
_C.SOLVER.weight_da = 1.0
_C.SOLVER.weight_cr = 1.0
